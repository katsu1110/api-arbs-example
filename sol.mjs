...
const wallet = new Wallet(
  ...
  Keypair.fromSecretKey(bs58.decode(process.env.STEPN_PRIVATE || ""))
);

const FIRST_MINT = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"; //USDC
// const SECOND_MINT = "So11111111111111111111111111111111111111112"; //SOL
const SECOND_MINT = "So11111111111111111111111111111111111111112"; //SOL
// const SECOND_MINT = 'UsTmCn19utRfsjGfS2JBkWcfEs8Jn3UU7SQAAgz52A4' // UST
// const SECOND_MINT = 'AFbX8oGjGpmVFywbVouvhQSRmiW2aR1mohfahi4Y2AdB' //GST
// const SECOND_MINT = '7i5KKsX2weiTkry7jA4ZwSuXGhs5eJBEjY8vVxR4pfRx' //GMT
// const SECOND_MINT = 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB' //USDT
...
while (true) {
  // 0.1 SOL
  const usdcToSol = await getCoinQuote(FIRST_MINT, SECOND_MINT, initial);
